  ...
  return (
    <div className="container_section">
      <div className="items-center justify-center h-full flex">
        {noFound ? (
          <p className="items-center justify-center h-[80vh] flex text-2xl font-semibold text-gray-500">
            {noFound}
          </p>
        ) : (
          <div className="mt-28">
              ...
              {favorite.length > 0 && (
                <div>
                  <button
                    ...
                    className="text-xl text-white bg-gray-600 rounded block text-center py-2 px-6 mx-auto">
                    Delate All Favorite Items
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="text-center mt-4 ">
              <h2 className="text-xl">
                Total Favorite Items: {favorite.length}
              </h2>
              <h3>
